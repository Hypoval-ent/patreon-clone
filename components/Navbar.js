...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-around bg-gray-900 shadow-white text-white px-4 h-16 items-center ">
      {/* Logo */}
      <Link
      ...
      <div>
        <ul className=" flex gap-10 items-center ">
          ...
          <li>About</li>
          <li>Projects</li>
          <li className="relative flex justify-center items-center  md:block gap-4">
            {session && (
              <>
                <button
